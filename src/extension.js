...
class StageSidebar {
  ...
  _build() {
    ...
    this._sig(this._edge, 'enter-event', () => {
      ...
      // Dwell delay — pointer must stay on the edge strip for N ms before the
      // sidebar reveals. Prevents accidental triggers when brushing the edge
      // on the way to left-edge app UI (e.g. Zen browser vertical tabs).
